...
@implementation MSVShaderProgram
...
-(id) initWithVertexShaderFileName:(NSString*) vertexShaderFileName andFgramentShaderFileName:(NSString*) fragmentShaderFileName
{
    ...
    {
        //<init source
        _vertShaderPathName = [MSVPath pathInBundleForResource:vertexShaderFileName ofType:@"glsl"];
        _fragShaderPathName = [MSVPath pathInBundleForResource:fragmentShaderFileName ofType:@"glsl"];
        ...
        GLuint vertexShaderHandle     = [MSVShaderUtils compileShaderOfType:GL_VERTEX_SHADER file:_vertShaderPathName];
        GLuint fragmentShaderHandle   = [MSVShaderUtils compileShaderOfType:GL_FRAGMENT_SHADER file:_fragShaderPathName];
        
        //<compile
        _programHandle = [MSVShaderUtils compileProgramWithVertexShaderHandle:vertexShaderHandle andFragmentShaderHandle:fragmentShaderHandle];
        
        //<link
        [MSVShaderUtils linkProgram:_programHandle];
        
        //<detach
        [MSVShaderUtils detachShader:vertexShaderHandle fromProgram:_programHandle];
        [MSVShaderUtils detachShader:fragmentShaderHandle fromProgram:_programHandle];
    }
...
{
    return [[MSVShaderProgram alloc] initWithVertexShaderFileName:vertexShaderFileName andFgramentShaderFileName:fragmentShaderFileName];
}
